 ...
 * Simple version - creates users, orders, licenses, webhooks
 */
...
async function createAllTables() {
  try {
    ...
    const tables = ['users', 'orders', 'order_items', 'licenses', 'webhook_events'];
    ...
    console.log('   System is now ready for:');
    console.log('   - User authentication');
    console.log('   - Stripe webhook processing');
    console.log('   - Automatic order creation');
